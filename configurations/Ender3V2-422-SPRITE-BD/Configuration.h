...
#define STRING_CONFIG_H_AUTHOR "Chris Gavalier (GavieChr)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender3V2-422-SPRITE-BD"
...
#define PIDTEMPBED  // Ender Configs
  ...
  #define DEFAULT_bedKp 156.89
  #define DEFAULT_bedKi 26.15
  #define DEFAULT_bedKd 627.57
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -26, -46.5, 0 } //Sprite Offsets 
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE    0 // (mm) Z Clearance for Deploy/Stow  // MRiscoC Increase speed
#define Z_CLEARANCE_BETWEEN_PROBES  1 // (mm) Z Clearance between probe points  // MRiscoC Increase probe compatibility
#define Z_CLEARANCE_MULTI_PROBE     1 // (mm) Z Clearance between multiple probes  // MRiscoC Increase speed
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 9  // MRiscoC Customizable by menu
...
#define NOZZLE_PARK_FEATURE  // MRiscoC Enabled
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 5), (Y_MAX_POS - 10), 50 }
